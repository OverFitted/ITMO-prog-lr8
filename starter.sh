...
nohup java -jar server/build/libs/server-1.0-SNAPSHOT-all.jar > server1.log &
nohup java -jar server/build/libs/server-1.0-SNAPSHOT-all.jar > server2.log &
nohup java -jar server/build/libs/server-1.0-SNAPSHOT-all.jar > server3.log &
